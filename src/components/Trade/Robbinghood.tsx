...
export const Robbinghood: React.FC = () => {
  ...
  const {
    ...
    intradayBars, marketTime, marketIsOpen, netWorthBars, netWorthAllDayBars,
    scheduledEvents, previousDayBars, allDayBars,
  } = useGameStore();
                ...
                <div style={{ position: 'relative' }}>
                  <div className="chart-container" style={{ width: '100%', backgroundColor: '#2b2b26', marginBottom: '16px', border: '2px solid #706b66', padding: '8px' }}>
                    <IntraChart
                      ...
                      allDayBars={allDayBars[selectedStock] || []}
